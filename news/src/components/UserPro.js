...
function Userpro() {
    ...
    const add = (event) => {
        ...
        axios.post('http://localhost/project7/php_crud/insert.php?&Title=' + Title + '&Type=' + Type + '&City=' + City + '&Phone=' + Phone + '&Des=' + Des + '&img=' + img + '&Date_Res=' + Date_Res + '&CardNum=' + CardNum + '&Expiry=' + Expiry + '&CVV=' + CVV)
            .then((data) => {
                document.getElementById("addAds").style.display = "block";
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <div class="px-4 py-3">
                        ...
                        <div class="py-4 px-4">
                            ...
                            <div id="addAds" className="alert alert-success" role="alert" style={{ display: 'none' }}>
                                <p class="alert-heading">your Ads have been added successfully!</p>
                            </div>
                            ...
                            <form class="form-card" onsubmit="event.preventDefault()">
                                ...
                                <div class="container row">
                                    ...
                                    <div class="alert alert-secondary col-md-5 alertstyle " role="alert">
                                        <p>You can choose the duration of your advertisement on our website:</p> <br></br>
                                        <small>For one day, one dinar</small><br></br>
                                        <small>For a month 50 dinars</small><br></br>
                                        <small>For six months 60 dinars</small>
                                    </div>
                                </div>
