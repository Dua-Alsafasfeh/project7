...
function Tech() {
    ...
    useEffect(() => {
        ...
        const response = await axios.get("https://newsapi.org/v2/everything?q=apple&from=2022-07-11&to=2022-07-11&sortBy=popularity&apiKey=d8a14f5d0a7d45f395a26e95e34050b0");
  ...
  return (
    <div className="container tech" style={{width: '60%'}}>
               <div class="line top">
